...
poparcie_polityczne = pd.read_excel(
    "C:\\Users\\cypri\\Desktop\\Python_projects\\PrzyrostNaturalny_Polityka\\wyniki_gl_na_listy_po_p"
    "owiatach_proc_sejm_utf8.xlsx", dtype={'JPT_KOD_JE': str})
mapa_polski = gpd.read_file("C:\\Users\\cypri\\Desktop\\Pytho"
                            "n_projects\\PrzyrostNaturalny_Polityka\\A02_Granice_powiatow.shp")
...
gminy_joined_KO = mapa_polski.merge(poparcie_polityczne, on='JPT_KOD_JE', how='left')
poparcie = poparcie_polityczne
...
gminy_joined_KO['Poparcie polityczne przedziały'] = (
    pd.cut(gminy_joined_KO['Poparcie polityczne'], bins=bins, labels=labels))

# Wyświetl wynik
print(gminy_joined_KO)

# Tworzenie wykresu
fig, ax = plt.subplots(figsize=(12, 12))

# Rysowanie mapy z odpowiednimi kolorami na podstawie przedziałów poparcia politycznego
gminy_joined_KO.plot(column='Poparcie polityczne przedziały', ax=ax, legend=True,
...
plt.title("Mapa poparcia politycznego dla Koalicji Obywatelskiej, 2023")
plt.show()
