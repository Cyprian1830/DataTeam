...
poparcie_polityczne = pd.read_excel("C:\\Users\\cypri\\Desktop\\Pyt"
                                    "hon_projects\\PrzyrostNaturalny_Polityka\\wyni"
                                    "ki_gl_na_listy_po_powiatach_proc_sejm_utf8.xlsx", dtype={'JPT_KOD_JE': str})
mapa_polski = gpd.read_file("C:\\Users\\cypri\\Desktop\\Python_pro"
                            "jects\\PrzyrostNaturalny_Polityka\\A02_Granice_powiatow.shp")
poparcie_polityczne = poparcie_polityczne.iloc[0:, [0, 15]]
...
plt.title("Mapa poparcia politycznego dla Prawa i Sprawiedliwości, 2023")
plt.show()
