...
poparcie_polityczne = pd.read_excel("C:\\Users\\cypri\\Desktop"
                                    "\\Python_projects\\PrzyrostNaturalny_Polityka\\"
                                    "wyniki_gl_na_listy_po_powiatach_proc_sejm_utf8.xlsx", dtype={'JPT_KOD_JE': str})
mapa_polski = gpd.read_file("C:\\Users\\cypri\\Desktop\\Python_projec"
                            "ts\\PrzyrostNaturalny_Polityka\\A02_Granice_powiatow.shp")
poparcie_polityczne = poparcie_polityczne.iloc[0:, [0, 14]]
...
plt.title("Mapa poparcia politycznego dla Nowej Lewicy, 2023")
plt.show()
